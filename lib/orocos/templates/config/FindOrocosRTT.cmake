...
IF ( OROCOS_PKGCONFIG_EXECUTABLE AND NOT SKIP_BUILD)

    MESSAGE( STATUS "Detecting RTT" )
    SET(OROCOS_TARGET "gnulinux" CACHE STRING "")
    IF (OROCOS_INSTALL)
	SET(ENV{PKG_CONFIG_PATH} "$ENV{PKG_CONFIG_PATH}:${OROCOS_INSTALL}/lib/pkgconfig:${OROCOS_INSTALL}/packages/install/lib/pkgconfig/")
    ENDIF(OROCOS_INSTALL)
    ...
    IF ( OROCOS_RTT_FLAVORS ) 
      ...
      FOREACH(FLAVOR ${OROCOS_RTT_FLAVORS})
       ...
       OROCOS_PKGCONFIG("${FLAVOR} >= 1.3.0" OROCOS_RTT_${FLAVOR_TARGET_CAP}_1.4 OROCOS_RTT_${FLAVOR_TARGET_CAP}_INCLUDE_DIRS_1.4 OROCOS_RTT_${FLAVOR_TARGET_CAP}_DEFINES_1.4 OROCOS_RTT_${FLAVOR_TARGET_CAP}_LINK_DIRS_1.4 OROCOS_RTT_${FLAVOR_TARGET_CAP}_LIBS_1.4 )
	 ...
	 # set paths
	 OROCOS_PKGCONFIG( "orocos-rtt-${FLAVOR_TARGET} >= 1.0.0" OROCOS_RTT OROCOS_RTT_INCLUDE_DIRS OROCOS_RTT_DEFINES OROCOS_RTT_LINK_DIRS OROCOS_RTT_LIBS )
    ...
    ELSE ( OROCOS_RTT_FLAVORS ) 
      ...
      OROCOS_PKGCONFIG( "orocos-rtt-${OROCOS_TARGET} >= 1.1.0" OROCOS_RTT_1.2 OROCOS_RTT_INCLUDE_DIRS_1.2 OROCOS_RTT_DEFINES_1.2 OROCOS_RTT_LINK_DIRS_1.2 OROCOS_RTT_LIBS_1.2 )
      OROCOS_PKGCONFIG( "orocos-rtt-${OROCOS_TARGET} >= 1.0.0" OROCOS_RTT OROCOS_RTT_INCLUDE_DIRS OROCOS_RTT_DEFINES OROCOS_RTT_LINK_DIRS OROCOS_RTT_LIBS )
...
ELSE  ( OROCOS_PKGCONFIG_EXECUTABLE  AND NOT SKIP_BUILD)

    IF (NOT OROCOS_PKGCONFIG_EXECUTABLE)
    # Can't find pkg-config -- have to search manually
    MESSAGE( FATAL_ERROR "Can't find pkg-config ")
    ENDIF (NOT OROCOS_PKGCONFIG_EXECUTABLE)

ENDIF ( OROCOS_PKGCONFIG_EXECUTABLE  AND NOT SKIP_BUILD)

IF(OROCOS_RTT)
    SET(OrocosRTT_FOUND TRUE)
ENDIF(OROCOS_RTT)
